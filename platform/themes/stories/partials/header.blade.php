                ...
                <div class="container">
                    <div class="row pt-20 pb-20">
                        ...
                        <div class="col-md-9 col-6 text-right header-top-right">
                            ...
                            <button class="search-icon d-inline"><span class="mr-15 text-muted font-small"><i class="elegant-icon icon_search mr-5"></i>{{ __('ຄົ້ນຫາ') }}</span></button>
                        ...
                        <div class="col-12 align-self-center main-search-form-cover m-auto">
                            <form action="{{ is_plugin_active('blog') ? route('public.search') : '#' }}" class="search-header">
                                <div class="input-group w-100">
                                    <input type="text" name="q" class="form-control" placeholder="{{ __('ຄົ້ນຫາຂໍ້ມູນຂ່າວສານ...') }}">
